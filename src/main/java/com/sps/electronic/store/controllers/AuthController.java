...
import com.sps.electronic.store.dtos.JwtRequest;
import com.sps.electronic.store.dtos.JwtResponse;
...
import com.sps.electronic.store.security.JwtHelper;
...
//        maxAge = 3600   //this is in seconds 60minutes
//)
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody JwtRequest request){
        //if username or password wrong then this method will call
    ...
    public ResponseEntity<JwtResponse> loginWithGoogle(@RequestBody Map<String, Object> data) throws IOException {
        ...
        //we have to verify the token present in data
        //get the id token from request
        String idToken= data.get("idToken").toString();

        NetHttpTransport netHttpTransport = new NetHttpTransport();

        //this JacksonFactory class is not present in this google api client dependency
        //so change the version 2.1.2 to 1.30.9
        ...
        //this is above idToken

        //idToken this id token is given to the apis and get payload
    ...
    private User saveUser(String email, String name, String photoUrl) {
        ...
        //createUser method will do everything creating id then encoded password
        //whatever we have done in createUser method
